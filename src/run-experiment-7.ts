...
console.log(`  Question set: consumer_preferences (with 4 reverse-coded SD questions)`);
console.log(`  Concurrency: 10 parallel persona interviews`);
console.log(`  Budget: $15.00`);

const config: ExperimentConfig = {
  name: '7. General Population v2 (n=500)',
  dataset: 'bls',
  personaCount: 500,
...
console.log(`\n${'='.repeat(60)}`);
console.log('STARTING: 7. General Population v2 (n=500)');
...
try {
  ...
  console.log(`\n${'='.repeat(60)}`);
  console.log('RESULT: 7. General Population v2 (n=500)');
  console.log(`${'='.repeat(60)}`);
